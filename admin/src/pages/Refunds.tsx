  ...
  return (
    <Layout>
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold text-neutral-900">Refunds</h1>
          <p className="text-neutral-600 mt-1">Manage refund requests</p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-neutral-200 overflow-hidden">
          <table className="w-full">
            <thead className="bg-neutral-50 border-b border-neutral-200">
              <tr>
                <th className="px-6 py-3 text-left text-sm font-semibold text-neutral-900">Order ID</th>
            ...
            <tbody>
              {loading ? (
                ...
                filteredRefunds.map((refund) => (
                  <tr key={refund.id} className="border-b border-neutral-100 hover:bg-neutral-50">
                    <td className="px-6 py-4 font-medium text-neutral-900">{refund.orderId}</td>
                    <td className="px-6 py-4 font-medium text-neutral-900">₦{refund.amount.toLocaleString()}</td>
                    <td className="px-6 py-4 text-neutral-600">{refund.reason}</td>
                    ...
                    <td className="px-6 py-4">
                      {refund.status === 'pending' && (
                        <div className="flex items-center gap-2">
                          ...
                          <button className="p-2 hover:bg-error/10 rounded transition-colors">
